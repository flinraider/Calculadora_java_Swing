...
public class Memoria {
	...
	private List<MemoriaObservador> observadores = 
	...
	private String obterResultadoOperacao() {
		...
		String textoRes = Double.toString(resultado).replace(".", ",");
		boolean inteiro = textoRes.endsWith(",0");
		return inteiro ? textoRes.replace(",0","") : textoRes;
	}
